...
dnl flumotion projects work with base flumotion projects

dnl FLUMOTION_SETUP(RELATIVE_PATH, FLUMOTION_DIR, PREAMBLE)
...
def setup():
    ...
    __packagePath = os.path.join(*pplist)
    ...
    # now set up the other package paths
